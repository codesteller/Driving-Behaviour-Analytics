...
ROTATE_FRAME = True  # Set to True if you want to rotate the frame
                ...
                try:
                    ...
                    if analysis and isinstance(analysis, list) and len(analysis) > 0:
                        for emotion, score in analysis[0]['emotion'].items():
                            ...
                            cv2.rectangle(frame, (100, 100 + 20 * list(analysis[0]['emotion'].keys()).index(emotion)), (300, 120 + 20 * list(analysis[0]['emotion'].keys()).index(emotion)), (0, 0, 0), -1)
                            cv2.rectangle(frame, (100, 100 + 20 * list(analysis[0]['emotion'].keys()).index(emotion)), (100 + int(score * 200), 120 + 20 * list(analysis[0]['emotion'].keys()).index(emotion)), (255, 255, 0), -1)
